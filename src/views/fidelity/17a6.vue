          ...
          <div id='fi-17-flow' class="opac-0 m-b-25" :class="{ 'animated fadeInUp': scrollY > 1075 || isApplied('fi-17-flow') }">
            <div class="row">
              <div class='col-md-5'>
                ...
                <p>This flow only looked at the experience as a whole. It was later decided that a lot of the functionality requested would not be able to be done for a MVP release. Some functionality was also later decided not to be needed on certain pages and as a result was moved around.</p>
              </div>
              <div class='col-md-7'>
          ...
          <div id='fi-17-1' class="opac-0 m-b-25" :class="{ 'animated fadeInUp': scrollY > 1461 || isApplied('fi-17-1') }">
            <div class="row">
              ...
              <div class='col-md-5'>
                ...
                <p>The 17a6 project kicked off in the middle of the redesign project so there was a huge push to use the new components created. The idea here was similar to the redesign in that the business wanted to avoid scrolling but they wanted to see nearly all data points needed for an account. At this point, those data points weren't completely decided so I had to wing it on figuring out what information was most important.</p>
                <p>The users wanted to stray away from the use of tables as the current tables they had were old technology and could not function like more modern tables. However, the development team stated that they could not use any of the designs with card components due to technology limitations. In the end the users agreed to the use of a table if and only if it could be designed and developed as close to their needs as possible.</p>
              </div>
            </div>
          </div>
          <div id='fi-17-2' class="opac-0 m-b-25" :class="{ 'animated fadeInUp': scrollY > 2201 || isApplied('fi-17-2') }">
            <div class="row">
              <div class='col-md-5'>
                ...
                <p>Those needs weren't entirely easy to meet. The requirements changed almost every meeting. One of the core requirements were that the users needed a way to indicate that they had "okay'd" a line item in an account. The reason for this was because sometimes an account could have hundreds upon hundreds of line items and a user may not finish reviewing an account that day. When they came back to the account they needed to know that they were already part way done and didn't have to start over.</p>
