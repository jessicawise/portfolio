            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 align-left">
                    ...
                    <p><ul><li>
                        ...
                        a step by step process would be more confusing or troublesome to users.</li>
                        <li>Offer prefilled templates. This would allow even more time savings for users. However, would adding 
                            ...
                            can also be made to just have the templates already prefilled and allow users to just change them.</li>
