        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 align-left">
                    ...
                    <p><ul><li>Add a way to tell if a toll was Executed or Canceled on the Processed category. Currently in the 
                        ...
                        <li>Allowing execution or cancelation on the Unassigned category. Logic should be added to say that if a user 
                            ...
                            because it is also possible that the reservation information is needed for bookkeeping purposes.</li>
                            <li>Testing. Exploration is nice but it can't be implemented without some user testing first. Unfortunately,
                                ...
                                things while features they were requesting weren't done yet.</li></ul></p>
                </div>
            </div>
        </div>
    </div>
